...
\begin{definition}[Multiplexers (MUX)]
...
\begin{example}[MUX as a Universal Logic Element]
...
\begin{definition}[Full Adder (FA)]
...
\begin{important}[Ripple Carry Adder (RCA)]
...
\begin{example}[Programmable Logic Array (PLA)]
