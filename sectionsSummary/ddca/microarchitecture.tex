...
\begin{definition}
\textbf{Microarchitecture} implements an ISA. One ISA can have many microarchitectures (single-cycle, multi-cycle, pipelined) optimized for performance, cost, or power.
\end{definition}
