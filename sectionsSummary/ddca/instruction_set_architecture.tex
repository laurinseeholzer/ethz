...
To access memory, the \textbf{Memory Address Register (MAR)} holds the target address, and the \textbf{Memory Data Register (MDR)} receives/holds the data.
\end{definition}
...
\begin{remark}
Execution order altered by \textbf{Conditional Branches} (uses condition codes like N, Z, P or direct register comparisons) and \textbf{Unconditional Jumps}.
\end{remark}
