...
\begin{remark}
    Use \textbf{volatile} in Java to prevent memory reordering by updating the local cache/buffer every time the variable changes.
\end{remark}
...
\begin{remark}
    Synchronization actions establish HB dependencies between actions in different threads.
    \begin{itemize}
