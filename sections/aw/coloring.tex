...
\textbf{Greedy Coloring}:\\

                Requires at most $\Delta(G)+1$ colors.
                \\

\textbf{Heuristic}: Delete vertices in order of minimum degree. Gives $\le k+1$ colors if all
                subgraphs
                have a vertex with degree $\le k$.
