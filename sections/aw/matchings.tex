...
\textbf{Greedy Algorithm}:\\
                ...
                While there are still edges in $E$ choose an arbitrary edge $e \in E$ and add it to $M$. Remove all
                edges incident to the endpoints of $e$ from $E$.
                \\

                This leads to a maximal matching $M$. The size of $M$ is at least half the size of a maximum
                matching.
